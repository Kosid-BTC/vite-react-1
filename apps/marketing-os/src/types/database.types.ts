...
type WorkspaceStateRow = { workspace_id:string; data:Json; updated_at:string };
...
type BrandRuleRow = { id:string; workspace_id:string; brand_id:string; rule_type:string; severity:'info'|'warning'|'blocking'; pattern:string|null; description:string; active:boolean; created_at:string };
...
type ChannelRow = { id:string; org_id:string; name:string; niche:string|null; youtube_channel_id:string|null; oauth_secret_id:string|null; quota_project_key:string|null; created_at:string; cta_template:string|null; script_style:string; proof_points:Json; image_source:string };
...
export type Database = {
  public: {
    Tables: {
      ...
      workspace_state: Table<WorkspaceStateRow>;
      ...
      marketing_brand_rules: Table<BrandRuleRow>;
